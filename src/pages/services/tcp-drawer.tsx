import { createTcpService, getServiceInfo, updateTcpService } from '@/services/service/api'
  ...
  return (
    <Drawer open={drawerOpen} onOpenChange={setDrawerOpen} direction="right">
      <DrawerContent className="overflow-y-auto h-screen overflow-x-hidden">
        <DrawerHeader>
          <DrawerTitle>{serviceId ? '编辑TCP服务' : '添加TCP服务'}</DrawerTitle>
          <DrawerDescription>填写TCP服务信息以{serviceId ? '更新TCP服务信息' : '创建新的TCP服务'}</DrawerDescription>
        </DrawerHeader>
        <form
